...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-77.193525, 38.820293, -76.975788, 38.943965], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([-77.193525, 38.820293, -76.975788, 38.943965], map.getSize());
...
function createPopupField(currentFeature, currentFeatureKeys, layer) {
    ...
    for (var i = 0; i < currentFeatureKeys.length; i++) {
        if (currentFeatureKeys[i] != 'geometry' && !currentFeatureKeys[i].startsWith('q2wHide')) {
            var popupField = '';
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mode of Transportation to Work: Drove Alone</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (34 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Using 2022 Census ACS 5-Year Data.';
            }
